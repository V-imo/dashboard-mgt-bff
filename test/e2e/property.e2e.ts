...
test("should create a property", async () => {
  ...
  await eventualAssertion(
    async () => {
      const res = await apiClient.getProperty(property.agencyId, propertyId)
      return res
    },
    async (json) => {
...
test("should delete a property", async () => {
  ...
  await apiClient.deleteProperty(property.agencyId, propertyId)
...
test("should query properties", async () => {
  ...
  const stillAnotherProperty = generateProperty({ agencyId: property.agencyId })
  ...
  await eventualAssertion(
    async () => {
      const res = await apiClient.getProperties(property.agencyId)
      return res
    },
    async (json) => {
